...
if __name__ == '__main__':
    ...
    encap_tbl_D = {0: '00', 1: '10'}     # used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {(0, '00'): (2, '20'), (1, '10'): (3, '30')}    # table used to forward MPLS frames
    ...
    encap_tbl_D = {}
    frwd_tbl_D = {(0, '10'): (2, '30'), (1, '20'): (2, '30')}
    decap_tbl_D = ('30')
    ...
    host_2.udt_send('H3', 'MESSAGE_FROM_H2')
